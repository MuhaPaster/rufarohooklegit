...
namespace csgo {
	...
	extern bool   bomb_defused;
	extern float  planted_c4_explode_time;
	extern vec3_t planted_c4_explosion_origin;
	extern float  planted_c4_damage;
	extern float  planted_c4_radius;
	extern float  planted_c4_radius_scaled;
}