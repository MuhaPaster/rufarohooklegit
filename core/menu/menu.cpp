...
void menu::draw() {
	...
	option_bool(x, &y, "Nightmode:", &variables::darkmode, VK_MULTIPLY);
	...
	option_bool(x, &y, "Aimbot:", &variables::aimbot, VK_NUMPAD1);
	option_bool(x, &y, "Silent:", &variables::silent, VK_NUMPAD2);
	option_int(x, &y, "FOV:", &variables::fov, std::vector<std::string>{ "0", "1", "2", "3", "4", "5", "6" }, VK_NUMPAD3, true);
	//option_int(x, &y, "Hitbox:", &variables::targetting, std::vector<std::string>{ "Head", "Stomach" }, VK_NUMPAD3, true);
